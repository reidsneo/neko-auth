...
use Neko\Auth\OAuth2\Entity\Entity;
use Neko\Auth\OAuth2\ScopeValidator;
use Neko\Auth\OAuth2\Storage\Adapter;
use Neko\Auth\OAuth2\Grant\GrantInterface;
...
class Authorization {
	...
	/**
	 * Create a new Neko\Auth\OAuth2Server\Authorization instance.
	 * 
	 * @param  \Neko\Auth\OAuth2Storage\Adapter  $storage
	 * @param  \Symfony\Component\HttpFoundation\Request  $request
	 * @return void
	 */
	public function __construct(Adapter $storage, Request $request)
	{
	 ...
	 * 
	 * @param  \Neko\Auth\OAuth2Grant\GrantInterface  $grant
	 * @return \Neko\Auth\OAuth2Server\Authorization
	 */
	...
	public function issueAccessToken(array $payload = [])
	{
		...
		if ( ! empty($payload))
		{
			$this->request->all()->replace($payload);
		}
		...
		if ( ! $grant = $this->request->get('grant_type'))
		{
	 ...
	 * 
	 * @param  \Neko\Auth\OAuth2Entity\Token  $accessToken
	 * @return string
	 */
	 ...
	 * 
	 * @param  \Neko\Auth\OAuth2Entity\Entity  $entity
	 * @return array
	 */
	 ...
	 * 
	 * @return \Neko\Auth\OAuth2Storage\Adapter
	 */
	 ...
	 * 
	 * @param  \Neko\Auth\OAuth2ScopeValidator
	 * @return \Neko\Auth\OAuth2Server\Authorization
	 */
